...
const Margintable = () => {
    ...
    return (
        <div className="w-full h-70 px-7 py-8 bg-white rounded-sm flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-8">
                {[
                    {
                        label: "1학년",
                        value: rate.grade1Ration,
                        color: "bg-main",
                    },
                    {
                        label: "2학년",
                        value: rate.grade2Ration,
                        color: "bg-second",
                    },
                    {
                        label: "3학년",
                        value: rate.grade3Ration,
                        color: "bg-third",
                    },
                ].map((grade, i) => (
                    <div key={i} className="flex gap-3.5 h-7 items-center">
